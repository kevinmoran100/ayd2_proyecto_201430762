...
<div class="modal fade" id="modalacreditar" role="dialog">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                        {!! Form::open(['id' => 'formacreditar', 'url' => 'acreditar']) !!}
                        ...
                        {!! Form::submit('Acreditar Dinero', ['id' => 'btnFormNuevoEstado','class' => 'btn btn-warning']) !!}
                        {!! Form::close() !!}
                    </div>
                </div>
